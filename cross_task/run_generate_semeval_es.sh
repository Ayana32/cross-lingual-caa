#!/bin/bash
#SBATCH --job-name=gen_semeval_es
#SBATCH --output=/users/acp25mk/cross-lingual-caa/logs/generate_semeval_es_%j.out
#SBATCH --error=/users/acp25mk/cross-lingual-caa/logs/generate_semeval_es_%j.err
