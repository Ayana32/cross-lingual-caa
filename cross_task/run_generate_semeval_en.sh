#!/bin/bash
#SBATCH --job-name=gen_semeval_en
#SBATCH --output=/users/acp25mk/cross-lingual-caa/logs/generate_semeval_en_%j.out
#SBATCH --error=/users/acp25mk/cross-lingual-caa/logs/generate_semeval_en_%j.err
