#!/bin/bash
#SBATCH --job-name=gen_semeval_ko
#SBATCH --output=/users/acp25mk/cross-lingual-caa/logs/generate_semeval_ko_%j.out
#SBATCH --error=/users/acp25mk/cross-lingual-caa/logs/generate_semeval_ko_%j.err
