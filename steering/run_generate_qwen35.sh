#!/bin/bash
#SBATCH --job-name=qwen35_generate
#SBATCH --output=/users/acp25mk/cross-lingual-caa/logs/qwen35_generate_%j.out
#SBATCH --error=/users/acp25mk/cross-lingual-caa/logs/qwen35_generate_%j.err
