#!/bin/bash
#SBATCH --job-name=pca_generate_kk
#SBATCH --output=/users/acp25mk/cross-lingual-caa/logs/generate_pca_kk_%j.out
#SBATCH --error=/users/acp25mk/cross-lingual-caa/logs/generate_pca_kk_%j.err
