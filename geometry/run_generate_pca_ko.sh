#!/bin/bash
#SBATCH --job-name=pca_generate_ko
#SBATCH --output=/users/acp25mk/cross-lingual-caa/logs/generate_pca_ko_%j.out
#SBATCH --error=/users/acp25mk/cross-lingual-caa/logs/generate_pca_ko_%j.err
