#!/bin/bash
#SBATCH --job-name=pca_generate_en
#SBATCH --output=/users/acp25mk/cross-lingual-caa/logs/generate_pca_en_%j.out
#SBATCH --error=/users/acp25mk/cross-lingual-caa/logs/generate_pca_en_%j.err
