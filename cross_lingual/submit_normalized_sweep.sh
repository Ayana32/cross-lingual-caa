#!/bin/bash
# Normalized vector sweep: EN/KO/ES/KK x layer 12-26 x multipliers -1.5/-1.0/-0.5/0.0/0.5/1.0/1.5
...
cfg = OmegaConf.create({
    ...
    "system_prompt": "",
    "apply_steer_hparam_paths": ["/users/acp25mk/cross-lingual-caa/hparams/Steer/caa_hparams/apply_caa_layer${LAYER}_m1.0.yaml"],
