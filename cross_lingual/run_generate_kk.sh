#!/bin/bash
#SBATCH --job-name=caa_generate_kk
#SBATCH --output=/users/acp25mk/cross-lingual-caa/logs/generate_kk_%j.out
#SBATCH --error=/users/acp25mk/cross-lingual-caa/logs/generate_kk_%j.err
