#!/bin/bash
#SBATCH --job-name=caa_generate_es
#SBATCH --output=/users/acp25mk/cross-lingual-caa/logs/generate_es_%j.out
#SBATCH --error=/users/acp25mk/cross-lingual-caa/logs/generate_es_%j.err
