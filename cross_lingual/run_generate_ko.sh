#!/bin/bash
#SBATCH --job-name=caa_generate_ko
#SBATCH --output=/users/acp25mk/cross-lingual-caa/logs/generate_ko_%j.out
#SBATCH --error=/users/acp25mk/cross-lingual-caa/logs/generate_ko_%j.err
